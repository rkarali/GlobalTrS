			  ...
			  <div class="col-md-12">
					...
					<!-- END PAGE TITLE & BREADCRUMB-->
						...
						<div class="portlet-body">
							...
							<th class="sorting" role="columnheader" tabindex="0" aria-controls="sample_editable_1" rowspan="1" colspan="1" style="width: 174px;" aria-label="
									 Full Name
								: activate to sort column ascending">
									 Yer
							</th>
							<th class="sorting" role="columnheader" tabindex="0" aria-controls="sample_editable_1" rowspan="1" colspan="1" style="width: 254px;" aria-label="
									 Points
								: activate to sort column ascending">
									 Açıklama
							</th>
