...
<head>
<meta charset="utf-8"/>
<title>Istanbul Hotels Admin Girişi</title>
...
<div class="content">
	...
	<form class="login-form" action="<?=base_url()?>admin/Login/login_ol" method="post">
		<h3 class="form-title">Admin Girişi</h3>
...
<!--		<div class="login-options">
			<h4>Şunları Kullanarak Giriş Yap</h4>
		...
		<div class="forget-password">
			...
			<p>
				...
				<a href="javascript:;" id="forget-password">
				 ...
				 tıklayarak şifrenizi yenileyin.
			</p>
		</div>
...
<!-- BEGIN COPYRIGHT -->
<div class="copyright">
	 2017 &copy; CityTransferIstanbul - Admin Dashboard Template.
</div>
<!-- END COPYRIGHT -->
...
<script src="<?=base_url()?>assets/admin/scripts/custom/login-soft.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<script>
